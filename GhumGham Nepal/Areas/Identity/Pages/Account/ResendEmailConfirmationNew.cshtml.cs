...
{
    [AllowAnonymous]
    public class ResendEmailConfirmationNewModel : PageModel
    {
        private readonly UserManager<GhumGhamNepalUser> _userManager;
        private readonly ISmtpEmailService _emailSender;

        public ResendEmailConfirmationNewModel(UserManager<GhumGhamNepalUser> userManager, ISmtpEmailService emailSender)
        {
