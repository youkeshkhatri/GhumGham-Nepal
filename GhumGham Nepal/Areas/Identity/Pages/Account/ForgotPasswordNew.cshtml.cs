...
{
    public class ForgotPasswordNewModel : PageModel
    {
        private readonly UserManager<GhumGhamNepalUser> _userManager;
        private readonly ISmtpEmailService _emailSender;

        public ForgotPasswordNewModel(UserManager<GhumGhamNepalUser> userManager, ISmtpEmailService emailSender)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                ...
                return RedirectToPage("./ForgotPasswordConfirmationNew");
            }
